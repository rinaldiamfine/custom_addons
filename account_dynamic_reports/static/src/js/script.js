...
// -------------------------TAX REPORT--------------------------------//
    var DynamicTaxMain = AbstractAction.extend({
        template: 'DynamicTaxMain',
        events: {
            'click #filter_apply_button': 'update_with_filter',
            'click #pdf': 'print_pdf',
            'click #xlsx': 'print_xlsx',
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                // });
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterSectionTaxReport', {
                        filter_data: datas[0],
                    }));
                    self.$el.find('#date_from').datepicker({
                        dateFormat: 'dd-mm-yy'
                ...
                console.log('++',datas[1])
                self.$('.py-data-container-orig').html(QWeb.render('tax_data', {
                    account_data: datas[1]
                }));
                self.loader_enable_ui();
            });
...
// -------------------------SALES REPORT--------------------------------//
    ...
    var DynamicSalesReport = AbstractAction.extend({
        template: 'DynamicSalesReport',
        events: {
            'click #filter_apply_button': 'update_with_filter',
            'click #pdf': 'print_pdf',
            'click #xlsx': 'print_xlsx',
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                // });
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterSectionSalesReport', {
                        filter_data: datas[0],
                    }));
                    self.$el.find('#date_from').datepicker({
                        dateFormat: 'dd-mm-yy'
                ...
                console.log('++',datas[1])
                self.$('.py-data-container-orig').html(QWeb.render('sales_data', {
                    sales_data: datas[1]
                }));
                self.loader_enable_ui();
            });
...
// -------------------------SALES TAX REPORT--------------------------------//
    ...
    var DynamicSalesTaxReport = AbstractAction.extend({
        template: 'DynamicSalesTaxReport',
        events: {
            'click #filter_apply_button': 'update_with_filter',
            'click #pdf': 'print_pdf',
            'click #xlsx': 'print_xlsx',
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'context': {
                        'active_model': 'ins.sales.tax.report',
                        'landscape': 1,
                        'from_js': true
                    },
                    'display_name': 'Tax Reports',
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                // });
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterSectionSalesTaxReport', {
                        filter_data: datas[0],
                    }));
                    self.$el.find('#date_from').datepicker({
                        dateFormat: 'dd-mm-yy'
                ...
                console.log('++',datas[1])
                self.$('.py-data-container-orig').html(QWeb.render('sales_tax_data', {
                    sales_tax_data: datas[1]
                }));
                self.loader_enable_ui();
            });
        },
...
// -------------------------PURCHASE TAX REPORT--------------------------------//
    ...
    var DynamicPurchaseTaxReport = AbstractAction.extend({
        template: 'DynamicPurchaseTaxReport',
        events: {
            'click #filter_apply_button': 'update_with_filter',
            'click #pdf': 'print_pdf',
            'click #xlsx': 'print_xlsx',
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'context': {
                        'active_model': 'ins.purchase.tax.report',
                        'landscape': 1,
                        'from_js': true
                    },
                    'display_name': 'Tax Reports',
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                // });
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterSectionPurchaseTaxReport', {
                        filter_data: datas[0],
                    }));
                    self.$el.find('#date_from').datepicker({
                        dateFormat: 'dd-mm-yy'
                ...
                console.log('++',datas[1])
                self.$('.py-data-container-orig').html(QWeb.render('purchase_tax_data', {
                    purchase_tax_data: datas[1]
                }));
                self.loader_enable_ui();
            });
        },
...
// -------------------------PURCHASE TAX REPORT--------------------------------//
    ...
    var DynamicProfitReport = AbstractAction.extend({
        template: 'DynamicProfitReport',
        events: {
            'click #filter_apply_button': 'update_with_filter',
            'click #pdf': 'print_pdf',
            'click #xlsx': 'print_xlsx',
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'context': {
                        'active_model': 'ins.profit.report',
                        'landscape': 1,
                        'from_js': true
                    },
                    'display_name': 'Tax Reports',
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                // });
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterSectionProfitReport', {
                        filter_data: datas[0],
                    }));
                    self.$el.find('#date_from').datepicker({
                        dateFormat: 'dd-mm-yy'
                ...
                console.log('++',datas[1])
                self.$('.py-data-container-orig').html(QWeb.render('profit_data', {
                    profit_data: datas[1]
                }));
                self.loader_enable_ui();
            });
    ...
    core.action_registry.add('dynamic.tax', DynamicTaxMain);
    core.action_registry.add('dynamic.sales', DynamicSalesReport);
    core.action_registry.add('dynamic.sales.tax', DynamicSalesTaxReport);
    core.action_registry.add('dynamic.purchase.tax', DynamicPurchaseTaxReport);
    core.action_registry.add('dynamic.profit', DynamicProfitReport);
