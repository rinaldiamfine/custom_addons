...
class InsTaxReportXlsx(models.AbstractModel):
    _name = 'report.account_dynamic_reports.ins_tax_report_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, record):
        ...
        self.sheet = workbook.add_worksheet('Tax Reports')
        ...
        if record:
            data = record.read()
            self.sheet.merge_range(0, 0, 0, 8, 'Tax Reports'+' - '+data[0]['company_id'][1], self.format_title)
